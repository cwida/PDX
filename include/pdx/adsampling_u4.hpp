#ifndef EMBEDDINGSEARCH_ADSAMPLING_U4_HPP
#define EMBEDDINGSEARCH_ADSAMPLING_U4_HPP

#include "pdx/pdxearch_u4x8.hpp"
 ...
 ******************************************************************/
class ADSamplingSearcherU4 : public PDXearchU4x8<L2> {
public:
    ADSamplingSearcherU4(IndexPDXIVFFlatU4x8 &pdx_index,
                       size_t ivf_nprobe, float epsilon0, Eigen::MatrixXf matrix,
                       PDXearchDimensionsOrder dimension_order)
            : PDXearchU4x8<L2>(pdx_index,
                           ivf_nprobe,
                           1,
                           dimension_order),
    ...
    void SetEpsilon0(float epsilon0) {
        ADSamplingSearcherU4::epsilon0 = epsilon0;
    }

    void SetMatrix(const Eigen::MatrixXf &matrix) {
        ADSamplingSearcherU4::matrix = matrix;
    }
