#ifndef EMBEDDINGSEARCH_ADSAMPLING_U8_HPP
#define EMBEDDINGSEARCH_ADSAMPLING_U8_HPP

#include "pdx/pdxearch_u8.hpp"
 ...
 ******************************************************************/
class ADSamplingSearcherU8 : public PDXearchU8<L2> {
public:
    ADSamplingSearcherU8(IndexPDXIVFFlatU8 &pdx_index,
                       size_t ivf_nprobe, float epsilon0, Eigen::MatrixXf matrix,
                       PDXearchDimensionsOrder dimension_order)
            : PDXearchU8<L2>(pdx_index,
                           ivf_nprobe,
                           1,
                           dimension_order),
    ...
    void SetEpsilon0(float epsilon0) {
        ADSamplingSearcherU8::epsilon0 = epsilon0;
    }

    void SetMatrix(const Eigen::MatrixXf &matrix) {
        ADSamplingSearcherU8::matrix = matrix;
    }
