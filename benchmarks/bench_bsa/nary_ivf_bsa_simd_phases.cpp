...
int main(int argc, char *argv[]) {
    ...
    std::string RESULTS_PATH = BENCHMARK_UTILS.RESULTS_DIR_PATH + "PHASES_IVF_NARY_BSA.csv";
    ...
    for (const auto & dataset : BenchmarkUtils::DATASETS) {
        ...
        float *nary_data = MmapFile32(BenchmarkUtils::NARY_BSA_DATA + dataset + "-ivf-dual-block");
