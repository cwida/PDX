...
int main(int argc, char *argv[]) {
    ...
    for (const auto & dataset : BenchmarkUtils::DATASETS) {
        ...
        pdx_data.Restore(BenchmarkUtils::PDX_ADSAMPLING_DATA + dataset + "-u7-v4-h64-b64-ivf");
        float * _matrix = MmapFile32(BenchmarkUtils::NARY_ADSAMPLING_DATA + dataset + "-u7-v4-h64-b64-matrix");
