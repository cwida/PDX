...
int main(int argc, char *argv[]) {
    ...
    std::cout << "==> PDX IVF2 ADSampling U8\n";
    ...
    for (const auto & dataset : BenchmarkUtils::DATASETS) {
        ...
        PDX::PDXTreeIndexU8 pdx_index;
        pdx_index.Restore(BenchmarkUtils::PDX_ADSAMPLING_DATA + dataset + "-ivf2-u8",
                          BenchmarkUtils::PDX_ADSAMPLING_DATA + dataset + "-ivf2-u8-matrix");
