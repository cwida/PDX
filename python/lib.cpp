...
PYBIND11_MODULE(compiled, m) {
    ...
    py::class_<PDX::IndexADSamplingIMISQ8>(m, "IndexADSamplingIMISQ8")
        ...
        .def("set_pruning_confidence", &PDX::IndexADSamplingIMISQ8::SetPruningConfidence, py::arg("confidence"))
    ...
    py::class_<PDX::IndexADSamplingIMIFlat>(m, "IndexADSamplingIMIFlat")
        ...
        .def("set_pruning_confidence", &PDX::IndexADSamplingIMIFlat::SetPruningConfidence, py::arg("confidence"))
